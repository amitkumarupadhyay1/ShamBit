-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_CONFIRMATION', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_CANCELLED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'ORDER_DELAYED', 'ORDER_READY_FOR_PICKUP', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'PAYMENT_PENDING', 'PAYMENT_REFUNDED', 'PAYMENT_DISPUTED', 'PAYMENT_CHARGEBACK', 'PRODUCT_APPROVED', 'PRODUCT_REJECTED', 'PRODUCT_OUT_OF_STOCK', 'PRODUCT_BACK_IN_STOCK', 'LOW_STOCK_ALERT', 'PRICE_DROP_ALERT', 'WISHLIST_ITEM_AVAILABLE', 'SELLER_APPLICATION_APPROVED', 'SELLER_APPLICATION_REJECTED', 'SELLER_PAYOUT_PROCESSED', 'SELLER_PAYOUT_FAILED', 'SELLER_ACCOUNT_SUSPENDED', 'SELLER_PERFORMANCE_ALERT', 'PROMOTION_ACTIVATED', 'PROMOTION_EXPIRED', 'PROMOTION_APPLIED', 'FLASH_SALE_STARTED', 'COUPON_EXPIRING_SOON', 'REVIEW_RECEIVED', 'REVIEW_APPROVED', 'REVIEW_REJECTED', 'REVIEW_RESPONSE_RECEIVED', 'SYSTEM_MAINTENANCE', 'SECURITY_ALERT', 'ACCOUNT_LOCKED', 'PASSWORD_RESET', 'EMAIL_VERIFICATION', 'TWO_FACTOR_ENABLED', 'LOGIN_FROM_NEW_DEVICE', 'MARKETING_CAMPAIGN', 'NEWSLETTER', 'PROMOTIONAL_OFFER', 'ABANDONED_CART_REMINDER', 'WELCOME_SERIES', 'SETTLEMENT_PROCESSED', 'SETTLEMENT_FAILED', 'SETTLEMENT_SCHEDULED', 'SETTLEMENT_DELAYED', 'INVENTORY_ADJUSTMENT', 'BULK_IMPORT_COMPLETED', 'BULK_IMPORT_FAILED', 'SUPPORT_TICKET_CREATED', 'SUPPORT_TICKET_UPDATED', 'SUPPORT_TICKET_RESOLVED', 'KYC_VERIFICATION_REQUIRED', 'KYC_VERIFICATION_APPROVED', 'KYC_VERIFICATION_REJECTED', 'TAX_DOCUMENT_READY');

-- CreateEnum
CREATE TYPE "NotificationChannel" AS ENUM ('IN_APP', 'EMAIL', 'SMS', 'PUSH', 'WEBHOOK', 'WHATSAPP', 'SLACK', 'TEAMS');
